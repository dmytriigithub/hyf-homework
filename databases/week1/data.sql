...
-- -- HOMEWORK DATABASE WEEK 2

-- 1. Add a task with these attributes: title, description, created, updated, due_date, status_id, user_id

insert into task (title, description, created, updated, due_date, status_id, user_id) values ('Learn Database', 'Type code', '2023-10-25 06:54:16', '2023-10-15 13:05:09', null, 2, 1);
...
UPDATE task 
SET due_date = '2027-12-23 10:13:42'
WHERE id = 23;
